...
@click.option('--precond',       help='Preconditioning & loss function', metavar='vp|ve|edm|uloss|usve', type=click.Choice(['vp', 've', 'edm', 'monotonicedm', 'uloss', 'usve']), default='edm', show_default=True)
